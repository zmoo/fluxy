...
typedef uint32_t UserFlags;
typedef uint32_t UserMessageId;
typedef uint8_t UserMessageType;
typedef uint32_t UserMessageFlags;
typedef uint8_t UserMessageVersion;
typedef int UserScore;
typedef uint8_t BufferScale;
